...
function createData(id, name, description, topics) {
  return { id, name, description, topics };
}

const rows = [
  createData("567", "React", "Module explains about React", "Topics1, Topics2 "),
  createData("568", "CSS", "Module explains about CSS", "Topics3, Topics4 "),
];
      ...
      <Table className={classes.table} aria-label="custom pagination table">
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell align="center">Topics Covered</StyledTableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {(rowsPerPage > 0
