    ...
    return (
        <div className={classes.root}>
            ...
            >
                ...
                <Divider />
                <List>
                    {["Account", "Dashboard", "Courses", "Groups", "Calendar", "History", "Studio", "Help"].map((text, index) => (
                        <ListItem button key="123">
                            <ListItemIcon>

                                {index === 0 ? <AccountBoxIcon /> : null}
                                {index === 1 ? <DashboardIcon /> : null}
                                {index === 2 ? <LibraryBooksIcon /> : null}
                                {index === 3 ? <GroupIcon /> : null}
                                {index === 4 ? <EventIcon /> : null}
                                {index === 5 ? <HistoryIcon /> : null}
                                {index === 6 ? <TheatersIcon /> : null}
                                {index === 7 ? <HelpIcon /> : null}
